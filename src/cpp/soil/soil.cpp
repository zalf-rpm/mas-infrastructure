  ...
  if(!initialized) {
    ...
    if(!initialized) {
      ...
      try {
        ...
        } else KJ_IF_MAYBE(file, fs->getRoot().tryOpenFile(pathToMonicaParamsSoil.append("CapillaryRiseRates.json"))) {
  ...
  if(!initialized) {
    ...
    if(!initialized) {
      ...
      try {
        ...
        } else KJ_IF_MAYBE(file, fs->getRoot().tryOpenFile(pathToMonicaParamsSoil.append("SoilCharacteristicModifier.json"))) {
          capnp::JsonCodec json;
          capnp::MallocMessageBuilder msg;
