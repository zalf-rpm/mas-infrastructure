...
void Tools::set_double_vectorD(std::vector<double> &var,
  ...
  if (v.is_array()) {
    if (v.array_items().size() > 1 && v[1].is_string() && v[0].is_array()) {
      var = double_vectorD(v[0], def, defaultValue);
...
std::vector<double> Tools::double_vectorD(const json11::Json &j,
  ...
  if (j.is_array()) {
    if (j.array_items().size() > 1 && j[1].is_string() && j[0].is_array()) {
      ...
      for (const json11::Json& v: j.array_items()) is.push_back(double_valueD(v, defaultValue));
      return is;
    }
...
void Tools::set_int_vectorD(std::vector<int> &var,
  ...
  if (v.is_array()) {
    if (v.array_items().size() > 1 && v[1].is_string() && v[0].is_array()) {
      var = int_vectorD(v[0], def, defaultValue);
    }
...
std::vector<int> Tools::int_vectorD(const json11::Json &j,
  ...
  if (j.is_array()) {
    if (j.array_items().size() > 1 && j[1].is_string() && j[0].is_array()) {
      ...
      std::vector<int> is;
      for (const json11::Json& v: j.array_items()) is.push_back(int_valueD(v, defaultValue));
      return is;
    }
...
void Tools::set_bool_vectorD(std::vector<bool> &var,
  ...
  if (v.is_null() && useDefault) { var = def; }
    ...
    if (v.array_items().size() > 1 && v[1].is_string() && v[0].is_array()) {
      var = bool_vectorD(v[0], def, defaultValue);
    }
...
std::vector<bool> Tools::bool_vectorD(const json11::Json &j,
  ...
  if (j.is_array()) {
    if (j.array_items().size() > 1 && j[1].is_string() && j[0].is_array()) {
      ...
      std::vector<bool> is;
      for (const json11::Json& v: j.array_items())
...
void Tools::set_string_vectorD(std::vector<std::string> &var,
  ...
  if (v.is_null() && useDefault) { var = def; }
    ...
    if (v.array_items().size() > 1 && v[1].is_string() && v[0].is_array()) {
      var = string_vectorD(v[0], def, defaultValue);
...
std::vector<string> Tools::string_vectorD(const json11::Json &j,
  ...
  if (j.is_array()) {
    if (j.array_items().size() > 1 && j[1].is_string() && j[0].is_array()) {
      ...
      for (const json11::Json &v: j.array_items()) is.push_back(string_valueD(v, defaultValue));
      return is;
    }
...
void Tools::set_int_valueD(int &var, const json11::Json &j, const std::string &key, int def, bool useDefault) {
  ...
  else if (v.is_array() && !v.array_items().empty() && v[0].is_number()) { var = v[0].int_value(); }
...
int Tools::int_valueD(const json11::Json &j, int def) {
  ...
  else if (j.is_array() && !j.array_items().empty() && j[0].is_number()) { return j[0].int_value(); }
...
void Tools::set_double_valueD(double &var,
                              ...
                              const std::string &key,
                              double def,
                              const std::function<double(double)> &transf,
                              bool useDefault) {
  const auto &v = j[key];
  ...
  else if (v.is_array() && !v.array_items().empty() && v[0].is_number()) { var = transf(v[0].number_value()); }
...
double Tools::double_valueD(const json11::Json &j, double def) {
  ...
  else if (j.is_array() && !j.array_items().empty() && j[0].is_number()) { return j[0].number_value(); }
...
void Tools::set_bool_valueD(bool &var, const json11::Json &j, const std::string &key, bool def, bool useDefault) {
  ...
  } else if (v.is_array() && !v.array_items().empty() && v[0].is_bool()) { var = v[0].bool_value(); }
...
bool Tools::bool_valueD(const json11::Json &j, bool def) {
  ...
  } else if (j.is_array() && !j.array_items().empty() && j[0].is_bool()) { return j[0].bool_value(); }
...
void Tools::set_string_valueD(string &var, const json11::Json &j, const std::string &key, const string &def,
                              bool useDefault) {
  auto v = j[key];
  if (v.is_null() && useDefault) { var = def; }
  else if (v.is_string()) { var = v.string_value(); }
  else if (v.is_array() && !v.array_items().empty() && v[0].is_string()) { var = v[0].string_value(); }
...
string Tools::string_valueD(const json11::Json &j, const string &def) {
  ...
  else if (j.is_array() && !j.array_items().empty() && j[0].is_string()) { return j[0].string_value(); }
