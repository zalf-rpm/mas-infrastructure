...
host="0.0.0.0", port=None, reg_sturdy_ref=None, id=None, name="ISIMIP AgMIP Phase3", description=None):
...
if __name__ == '__main__':
    asyncio.run(async_main("/beegfs/common/data/climate/isimip/AgMIP.input_csvs"))