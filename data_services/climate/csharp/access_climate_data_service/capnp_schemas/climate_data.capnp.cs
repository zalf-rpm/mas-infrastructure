...
namespace Mas.Rpc
{
    ...
    public class ClimateData : ICapnpSerializable
    {
        ...
        [TypeId(0x9faf5d8cb32ad18fUL), Proxy(typeof(ListTests_Proxy)), Skeleton(typeof(ListTests_Skeleton))]
        public interface IListTests : IDisposable
        {
            Task<IReadOnlyList<float>> TestLF32(CancellationToken cancellationToken_ = default);
            Task<IReadOnlyList<IReadOnlyList<float>>> TestLLF32(CancellationToken cancellationToken_ = default);
            Task<IReadOnlyList<int>> TestLI32(CancellationToken cancellationToken_ = default);
            Task<IReadOnlyList<IReadOnlyList<int>>> TestLLI32(CancellationToken cancellationToken_ = default);
        }

        public class ListTests_Proxy : Proxy, IListTests
        {
            public async Task<IReadOnlyList<float>> TestLF32(CancellationToken cancellationToken_ = default)
            {
                var in_ = SerializerState.CreateForRpc<Mas.Rpc.ClimateData.ListTests.Params_testLF32.WRITER>();
                var arg_ = new Mas.Rpc.ClimateData.ListTests.Params_testLF32()
                {};
                arg_.serialize(in_);
                var d_ = await Call(11506518431837639055UL, 0, in_.Rewrap<DynamicSerializerState>(), false, cancellationToken_).WhenReturned;
                var r_ = CapnpSerializable.Create<Mas.Rpc.ClimateData.ListTests.Result_testLF32>(d_);
                return (r_.Test1);
            }

            public async Task<IReadOnlyList<IReadOnlyList<float>>> TestLLF32(CancellationToken cancellationToken_ = default)
            {
                var in_ = SerializerState.CreateForRpc<Mas.Rpc.ClimateData.ListTests.Params_testLLF32.WRITER>();
                var arg_ = new Mas.Rpc.ClimateData.ListTests.Params_testLLF32()
                {};
                arg_.serialize(in_);
                var d_ = await Call(11506518431837639055UL, 1, in_.Rewrap<DynamicSerializerState>(), false, cancellationToken_).WhenReturned;
                var r_ = CapnpSerializable.Create<Mas.Rpc.ClimateData.ListTests.Result_testLLF32>(d_);
                return (r_.Test1);
            }

            public async Task<IReadOnlyList<int>> TestLI32(CancellationToken cancellationToken_ = default)
            {
                var in_ = SerializerState.CreateForRpc<Mas.Rpc.ClimateData.ListTests.Params_testLI32.WRITER>();
                var arg_ = new Mas.Rpc.ClimateData.ListTests.Params_testLI32()
                {};
                arg_.serialize(in_);
                var d_ = await Call(11506518431837639055UL, 2, in_.Rewrap<DynamicSerializerState>(), false, cancellationToken_).WhenReturned;
                var r_ = CapnpSerializable.Create<Mas.Rpc.ClimateData.ListTests.Result_testLI32>(d_);
                return (r_.Test1);
            }

            public async Task<IReadOnlyList<IReadOnlyList<int>>> TestLLI32(CancellationToken cancellationToken_ = default)
            {
                var in_ = SerializerState.CreateForRpc<Mas.Rpc.ClimateData.ListTests.Params_testLLI32.WRITER>();
                var arg_ = new Mas.Rpc.ClimateData.ListTests.Params_testLLI32()
                {};
                arg_.serialize(in_);
                var d_ = await Call(11506518431837639055UL, 3, in_.Rewrap<DynamicSerializerState>(), false, cancellationToken_).WhenReturned;
                var r_ = CapnpSerializable.Create<Mas.Rpc.ClimateData.ListTests.Result_testLLI32>(d_);
                return (r_.Test1);
            }
        }

        public class ListTests_Skeleton : Skeleton<IListTests>
        {
            public ListTests_Skeleton()
            {
                SetMethodTable(TestLF32, TestLLF32, TestLI32, TestLLI32);
            }

            public override ulong InterfaceId => 11506518431837639055UL;
            Task<AnswerOrCounterquestion> TestLF32(DeserializerState d_, CancellationToken cancellationToken_)
            {
                return Impatient.MaybeTailCall(Impl.TestLF32(cancellationToken_), test1 =>
                {
                    var s_ = SerializerState.CreateForRpc<Mas.Rpc.ClimateData.ListTests.Result_testLF32.WRITER>();
                    var r_ = new Mas.Rpc.ClimateData.ListTests.Result_testLF32{Test1 = test1};
                    r_.serialize(s_);
                    return s_;
                }
            ...
            Task<AnswerOrCounterquestion> TestLLF32(DeserializerState d_, CancellationToken cancellationToken_)
            {
                return Impatient.MaybeTailCall(Impl.TestLLF32(cancellationToken_), test1 =>
                {
                    var s_ = SerializerState.CreateForRpc<Mas.Rpc.ClimateData.ListTests.Result_testLLF32.WRITER>();
                    var r_ = new Mas.Rpc.ClimateData.ListTests.Result_testLLF32{Test1 = test1};
                    r_.serialize(s_);
                    return s_;
                }
            ...
            Task<AnswerOrCounterquestion> TestLI32(DeserializerState d_, CancellationToken cancellationToken_)
            {
                return Impatient.MaybeTailCall(Impl.TestLI32(cancellationToken_), test1 =>
                {
                    var s_ = SerializerState.CreateForRpc<Mas.Rpc.ClimateData.ListTests.Result_testLI32.WRITER>();
                    var r_ = new Mas.Rpc.ClimateData.ListTests.Result_testLI32{Test1 = test1};
                    r_.serialize(s_);
                    return s_;
                }
            ...
            Task<AnswerOrCounterquestion> TestLLI32(DeserializerState d_, CancellationToken cancellationToken_)
            {
                return Impatient.MaybeTailCall(Impl.TestLLI32(cancellationToken_), test1 =>
                {
                    var s_ = SerializerState.CreateForRpc<Mas.Rpc.ClimateData.ListTests.Result_testLLI32.WRITER>();
                    var r_ = new Mas.Rpc.ClimateData.ListTests.Result_testLLI32{Test1 = test1};
                    r_.serialize(s_);
                    return s_;
                }
        ...
        {
            [TypeId(0xefd401fcd2da6656UL)]
            public class Params_testLF32 : ICapnpSerializable
            {
                public const UInt64 typeId = 0xefd401fcd2da6656UL;
                void ICapnpSerializable.Deserialize(DeserializerState arg_)
                {
                    var reader = READER.create(arg_);
                    applyDefaults();
            ...
            [TypeId(0xdb008db0772b16b0UL)]
            public class Result_testLF32 : ICapnpSerializable
            {
                public const UInt64 typeId = 0xdb008db0772b16b0UL;
                void ICapnpSerializable.Deserialize(DeserializerState arg_)
                {
                    var reader = READER.create(arg_);
                    Test1 = reader.Test1;
                ...
                public IReadOnlyList<float> Test1
                {
                    get;
                    set;
                }
                ...
                public struct READER
                {
                    ...
                    public static implicit operator DeserializerState(READER reader) => reader.ctx;
                    public static implicit operator READER(DeserializerState ctx) => new READER(ctx);
                    public IReadOnlyList<float> Test1 => ctx.ReadList(0).CastFloat();
                }
                ...
                public class WRITER : SerializerState
                {
                    ...
                    public ListOfPrimitivesSerializer<float> Test1
                    {
            ...
            [TypeId(0xb187fcd19b6c5b44UL)]
            public class Params_testLLF32 : ICapnpSerializable
            {
                public const UInt64 typeId = 0xb187fcd19b6c5b44UL;
                void ICapnpSerializable.Deserialize(DeserializerState arg_)
                {
                    var reader = READER.create(arg_);
                    applyDefaults();
            ...
            [TypeId(0xffc7ada0c62b07c1UL)]
            public class Result_testLLF32 : ICapnpSerializable
            {
                public const UInt64 typeId = 0xffc7ada0c62b07c1UL;
                void ICapnpSerializable.Deserialize(DeserializerState arg_)
                {
                    var reader = READER.create(arg_);
                    Test1 = reader.Test1;
                ...
                public void serialize(WRITER writer)
                {
                    writer.Test1.Init(Test1, (_s2, _v2) => _s2.Init(_v2));
                }
                ...
                public IReadOnlyList<IReadOnlyList<float>> Test1
                {
                    get;
                    set;
                }
                ...
                public struct READER
                {
                    ...
                    public static implicit operator DeserializerState(READER reader) => reader.ctx;
                    public static implicit operator READER(DeserializerState ctx) => new READER(ctx);
                    public IReadOnlyList<IReadOnlyList<float>> Test1 => ctx.ReadList(0).Cast(_0 => _0.RequireList().CastFloat());
                }
                ...
                public class WRITER : SerializerState
                {
                    ...
                    public ListOfPointersSerializer<ListOfPrimitivesSerializer<float>> Test1
                    {
            ...
            [TypeId(0xb95e25e26d78bd6bUL)]
            public class Params_testLI32 : ICapnpSerializable
            {
                public const UInt64 typeId = 0xb95e25e26d78bd6bUL;
                void ICapnpSerializable.Deserialize(DeserializerState arg_)
                {
                    var reader = READER.create(arg_);
                    applyDefaults();
            ...
            [TypeId(0x9bdb4152819146b4UL)]
            public class Result_testLI32 : ICapnpSerializable
            {
                public const UInt64 typeId = 0x9bdb4152819146b4UL;
                void ICapnpSerializable.Deserialize(DeserializerState arg_)
                {
                    var reader = READER.create(arg_);
                    Test1 = reader.Test1;
                ...
                public IReadOnlyList<int> Test1
                {
                    get;
                    set;
                }
                ...
                public struct READER
                {
                    ...
                    public static implicit operator DeserializerState(READER reader) => reader.ctx;
                    public static implicit operator READER(DeserializerState ctx) => new READER(ctx);
                    public IReadOnlyList<int> Test1 => ctx.ReadList(0).CastInt();
                }
                ...
                public class WRITER : SerializerState
                {
                    ...
                    public ListOfPrimitivesSerializer<int> Test1
                    {
            ...
            [TypeId(0x96301eed9ff07b8bUL)]
            public class Params_testLLI32 : ICapnpSerializable
            {
                public const UInt64 typeId = 0x96301eed9ff07b8bUL;
                void ICapnpSerializable.Deserialize(DeserializerState arg_)
                {
                    var reader = READER.create(arg_);
                    applyDefaults();
            ...
            [TypeId(0xd0e75fcab85d3b9bUL)]
            public class Result_testLLI32 : ICapnpSerializable
            {
                public const UInt64 typeId = 0xd0e75fcab85d3b9bUL;
                void ICapnpSerializable.Deserialize(DeserializerState arg_)
                {
                    var reader = READER.create(arg_);
                    Test1 = reader.Test1;
                ...
                public IReadOnlyList<IReadOnlyList<int>> Test1
                {
                    get;
                    set;
                }
                ...
                public struct READER
                {
                    ...
                    public static implicit operator DeserializerState(READER reader) => reader.ctx;
                    public static implicit operator READER(DeserializerState ctx) => new READER(ctx);
                    public IReadOnlyList<IReadOnlyList<int>> Test1 => ctx.ReadList(0).Cast(_0 => _0.RequireList().CastInt());
                }
                ...
                public class WRITER : SerializerState
                {
                    ...
                    public ListOfPointersSerializer<ListOfPrimitivesSerializer<int>> Test1
                    {
                        get => BuildPointer<ListOfPointersSerializer<ListOfPrimitivesSerializer<int>>>(0);
                        set => Link(0, value);
                    }
                }
            }
