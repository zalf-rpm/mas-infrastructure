...
namespace Mas.Schema.Model.Monica
{
    ...
    public class SpeciesParameters : ICapnpSerializable
    {
        ...
        public struct READER
        {
            ...
            public bool HasStageMaxRootNConcentration => ctx.IsStructFieldNonNull(4);
            public IReadOnlyList<double> InitialOrganBiomass => ctx.ReadList(5).CastDouble();
            public bool HasInitialOrganBiomass => ctx.IsStructFieldNonNull(5);
            public IReadOnlyList<double> CriticalOxygenContent => ctx.ReadList(6).CastDouble();
            public bool HasCriticalOxygenContent => ctx.IsStructFieldNonNull(6);
            public IReadOnlyList<double> StageMobilFromStorageCoeff => ctx.ReadList(7).CastDouble();
            public bool HasStageMobilFromStorageCoeff => ctx.IsStructFieldNonNull(7);
            public IReadOnlyList<bool> AbovegroundOrgan => ctx.ReadList(8).CastBool();
            public bool HasAbovegroundOrgan => ctx.IsStructFieldNonNull(8);
            public IReadOnlyList<bool> StorageOrgan => ctx.ReadList(9).CastBool();
            public bool HasStorageOrgan => ctx.IsStructFieldNonNull(9);
    ...
    public class EnvironmentParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public Mas.Schema.Climate.RCP Rcp
            {
                ...
                set => this.WriteData(528UL, (ushort)value, (ushort)0);
            }
        }
    ...
    public class SimulationParameters : ICapnpSerializable
    {
        ...
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            ...
            NMinFertiliserPartition = CapnpSerializable.Create<Mas.Schema.Management.Params.MineralFertilization.Parameters>(reader.NMinFertiliserPartition);
        ...
        public Mas.Schema.Management.Params.MineralFertilization.Parameters NMinFertiliserPartition
        {
            get;
            set;
        }
        ...
        public struct READER
        {
            ...
            public Mas.Schema.Management.Params.MineralFertilization.Parameters.READER NMinFertiliserPartition => ctx.ReadStruct(3, Mas.Schema.Management.Params.MineralFertilization.Parameters.READER.create);
        ...
        public class WRITER : SerializerState
        {
            ...
            public Mas.Schema.Management.Params.MineralFertilization.Parameters.WRITER NMinFertiliserPartition
            {
                get => BuildPointer<Mas.Schema.Management.Params.MineralFertilization.Parameters.WRITER>(3);
                set => Link(3, value);
            }
    ...
    public class CropModuleParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public bool EnableVernalisationFactorFix
            {
                ...
                set => this.WriteData(966UL, value, false);
            }
        }
    }
